...
const HeroText = () => {
  return (
    <div className="flex flex-col mt-[120px] mb-[362px] max-w-[var(--container-width)] mx-auto gap-12">
      <div className="flex flex-col gap-8 h-[248px]">
        <h1 className="text-[var(--mainBlack)]  text-[76.29px] font-bebasNeue leading-[83.92px] tracking-[-0.04em]">
          SPRZEDAJEMY SAMOCHODY <br /> Z EUROPY
        </h1>
        <p className="text-[var(--mainBlack)] font-robotoCondensed w-[602px] leading-6">
