...
const HeroText = () => {
  return (
    <div className="mx-5 min-h-[85vh] sm:max-w-[600px] md:max-w-[700px] lg:max-w-[960px] xl:max-w-[var(--container-width)] flex flex-col mt-10 sm:mt-[120px] mb-5 sm:mb-[120px] md:mb-[240px]  lg:mb-[362px] sm:mx-auto gap-12 justify-between sm:justify-normal">
      ...
      <div className="flex flex-col gap-6 justify-center sm:justify-normal h-[200px]">
